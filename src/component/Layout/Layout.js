...
export class Layout extends Component{
    ...
    render(){
        return(
            <div style={layoutCss}>
                {
                    this.state.menuStatus?<React.Fragment> <Sidedrawer myStyle={{backround:"yellow"}} mobileView={this.state.menuStatus} closeMenu={this.closeMenu}    toggleAuthPage={this.toggleAuthInMenuState} /><Backdrop backdropClick={this.closeMenu} /></React.Fragment> : null
                }
